        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <section className="mb-8">
            ...
            <div className="prose text-gray-600">
              <p>
                By accessing and using ellesPay, you accept and agree to be
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    The materials on ellesPay are provided on an 'as is' basis.
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="text-gray-600">
                  ellesPay shall not be held liable for any damages.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="prose text-gray-600">
              <p>
                ...
                By using ellesPay you are agreeing to be bound by the current
          ...
          <section>
            ...
            <div className="bg-gray-50 rounded-lg p-6 flex items-center justify-between">
              ...
              <a
                href="mailto:legal@ellespay.com"
